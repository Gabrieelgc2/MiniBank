...
### 4 Requirement – Client: Fund Transfer (/transactions/transfer)
...
### 5 Requirement – Client: Loan Request (/loans/request)
- The general public can request loans by providing the desired amount and reason.
### 6 Requirement – Manager: View Loan Applications (/loans/all)
- Managers can view all loan requests and their respective statuses (PENDING, ACCEPTED, REJECTED).
### 7 Requirement – Manager: Accept or Reject Loan Applications (/loans/{loanId}/status)
